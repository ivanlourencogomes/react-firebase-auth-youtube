  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var useState = React4.useState, useEffect2 = React4.useEffect, useLayoutEffect2 = React4.useLayoutEffect, useDebugValue = React4.useDebugValue;
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var useRef2 = React4.useRef, useEffect2 = React4.useEffect, useMemo3 = React4.useMemo, useDebugValue = React4.useDebugValue;
...
function connect(mapStateToProps, mapDispatchToProps, mergeProps, {
  ...
  const wrapWithConnect = (WrappedComponent) => {
    ...
    function ConnectFunction(props) {
      const [propsContext, reactReduxForwardedRef, wrapperProps] = React2.useMemo(() => {
        const {
      ...
      const ContextToUse = React2.useMemo(() => {
        return propsContext && propsContext.Consumer && // @ts-ignore
        (0, import_react_is.isContextConsumer)(React2.createElement(propsContext.Consumer, null)) ? propsContext : Context;
      }, [propsContext, Context]);
      const contextValue = React2.useContext(ContextToUse);
      ...
      const childPropsSelector = React2.useMemo(() => {
        return finalPropsSelectorFactory(store.dispatch, selectorFactoryOptions);
      }, [store]);
      const [subscription, notifyNestedSubs] = React2.useMemo(() => {
        if (!shouldHandleStateChanges)
      ...
      const overriddenContextValue = React2.useMemo(() => {
      ...
      const lastChildProps = React2.useRef();
      const lastWrapperProps = React2.useRef(wrapperProps);
      const childPropsFromStoreUpdate = React2.useRef();
      const renderIsScheduled = React2.useRef(false);
      const isProcessingDispatch = React2.useRef(false);
      const isMounted = React2.useRef(false);
      const latestSubscriptionCallbackError = React2.useRef();
      ...
      const actualChildPropsSelector = React2.useMemo(() => {
        const selector = () => {
      ...
      const subscribeForReact = React2.useMemo(() => {
...
`;
      ...
      const renderedWrappedComponent = React2.useMemo(() => {
        return (
          // @ts-ignore
          React2.createElement(WrappedComponent, _extends({}, actualChildProps, {
            ref: reactReduxForwardedRef
          }))
        );
      }, [reactReduxForwardedRef, WrappedComponent, actualChildProps]);
      const renderedChild = React2.useMemo(() => {
        if (shouldHandleStateChanges) {
          return React2.createElement(ContextToUse.Provider, {
    ...
    const _Connect = React2.memo(ConnectFunction);
    const Connect = _Connect;
    Connect.WrappedComponent = WrappedComponent;
    Connect.displayName = ConnectFunction.displayName = displayName;
    if (forwardRef2) {
      const _forwarded = React2.forwardRef(function forwardConnectRef(props, ref) {
        return React2.createElement(Connect, _extends({}, props, {
